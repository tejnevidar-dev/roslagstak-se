...
const Blog = () => {
  return (
    <>
      ...
      <main>
        <div className="pt-24">
          <Breadcrumbs items={[{ name: "Hem", path: "/" }, { name: "Blogg" }]} />
        </div>
        <PageHero
          eyebrow="Blogg & tips"
          title="Allt om tak i Roslagen"
          text="Tips, guider och nyheter om takbyte, takrenovering och takläggning i Roslagens skärgård."
        />
