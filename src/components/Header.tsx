...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className={`pointer-events-none absolute inset-x-0 top-0 h-[190%] bg-gradient-to-b from-primary/25 via-primary/8 to-transparent transition-opacity duration-700 ${
