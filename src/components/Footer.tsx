  ...
  return (
    <footer className="bg-accent text-accent-foreground" role="contentinfo">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 border-b border-accent-foreground/15 pb-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            />
            <p className="max-w-sm text-sm leading-relaxed text-accent-foreground/65">
          ...
          <nav className="md:col-span-3" aria-label="Tjänster">
            <h3 className="mb-5 text-[11px] font-bold uppercase tracking-[0.28em] text-accent-foreground/50">Tjänster</h3>
            <ul className="space-y-2.5 text-sm text-accent-foreground/75">
              {tjanster.map((item) => (
                <li key={item.to}>
                  <Link to={item.to} className="transition-colors hover:text-accent-foreground">{item.label}</Link>
                </li>
              ))}
            </ul>
          </nav>
          ...
          <nav className="md:col-span-2" aria-label="Genvägar">
            <h3 className="mb-5 text-[11px] font-bold uppercase tracking-[0.28em] text-accent-foreground/50">Genvägar</h3>
            <ul className="space-y-2.5 text-sm text-accent-foreground/75">
              {genvagar.map((item) => (
                <li key={item.to}>
                  <Link to={item.to} className="transition-colors hover:text-accent-foreground">{item.label}</Link>
          ...
          <div className="md:col-span-2">
            <h3 className="mb-5 text-[11px] font-bold uppercase tracking-[0.28em] text-accent-foreground/50">Kontakt</h3>
            <ul className="space-y-3 text-sm text-accent-foreground/75">
              <li>
                <a href="tel:0701543639" className="flex items-center gap-2 font-semibold text-accent-foreground">
                  <Phone className="h-4 w-4" aria-hidden="true" /> 070-154 36 39
                </a>
              </li>
              <li>
                <a href="mailto:info@roslagstak.se" className="flex items-center gap-2 hover:text-accent-foreground">
              ...
              <li data-nosnippet="" className="text-accent-foreground/50">Org.nr: {orgNr}</li>
            </ul>
          </div>
        </div>

        <div className="flex flex-col gap-3 pt-6 text-xs text-accent-foreground/45 sm:flex-row sm:items-center sm:justify-between">
