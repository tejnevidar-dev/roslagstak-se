        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6 pt-4">
            ...
            <div className="bg-accent-foreground/5 border border-accent-foreground/10 rounded-lg p-6 text-center">
              ...
              <a
                href="#kontakt"
                className="inline-flex items-center gap-2 border border-primary text-primary px-6 py-3 rounded-md text-sm font-semibold hover:bg-primary hover:text-primary-foreground transition-colors hover:animate-subtle-pulse"
              >
                Skicka meddelande
              </a>
            </div>
