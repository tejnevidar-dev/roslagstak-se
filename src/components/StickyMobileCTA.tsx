...
const StickyMobileCTA = () => {
  ...
  return (
    ...
    >
      <a
        href="tel:0701543639"
        className="flex-1 flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3 rounded-full text-sm font-semibold animate-subtle-pulse"
      >
